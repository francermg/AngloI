/******************************************************************************/
/****          Generated by IBExpert 2.5.0.42 17/11/2004 08:01:22          ****/
/******************************************************************************/
...
SET GENERATOR GEN_ALUNOS TO 17676;

CREATE GENERATOR GEN_ALUNOS_SEMI;
SET GENERATOR GEN_ALUNOS_SEMI TO 154;
...
CREATE TABLE RECIBO (
    COD_ALUNOS_SEMI  INTEGER NOT NULL,
    COD_FUNC         INTEGER NOT NULL,
    PARCELA          INTEGER,
...
ALTER TABLE RECIBO ADD CONSTRAINT FK_RECIBO_SEMI FOREIGN KEY (COD_ALUNOS_SEMI) REFERENCES ALUNOS_SEMI (CODIGO) ON DELETE CASCADE;
