...
type
  TDoc_ContratoQR1 = class(TQuickRep)
    Rodape: TQRBand;
    QRShape1: TQRShape;
    QRShape2: TQRShape;
    QRLabel33: TQRLabel;
...
var
  Doc_ContratoQR1: TDoc_ContratoQR1;
...
procedure TDoc_ContratoQR1.RodapeBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
