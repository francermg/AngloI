...
begin
  ...
  Else Begin
      ...
      Doc_AluRecupQR.NomeTurma.Caption := IntToStr(DM.TurmasSERIE.Value)+'ª Série '+DM.TurmasTURMA.Value;
      ...
      Doc_AluRecupQR.D16.Caption := NomeDisc(16);
      Doc_AluRecupQR.D17.Caption := NomeDisc(17);
      Doc_AluRecupQR.D18.Caption := NomeDisc(18);
      Doc_AluRecupQR.D19.Caption := NomeDisc(19);
      Doc_AluRecupQR.D20.Caption := NomeDisc(20);
      Doc_AluRecupQR.D21.Caption := NomeDisc(21);
      Doc_AluRecupQR.D22.Caption := NomeDisc(22);
      Doc_AluRecupQR.D23.Caption := NomeDisc(23);
      Doc_AluRecupQR.D24.Caption := NomeDisc(24);
      Doc_AluRecupQR.D25.Caption := NomeDisc(25);
      Doc_AluRecupQR.D26.Caption := NomeDisc(26);
      Doc_AluRecupQR.D27.Caption := NomeDisc(27);
      Doc_AluRecupQR.D28.Caption := NomeDisc(28);
      Doc_AluRecupQR.D29.Caption := NomeDisc(29);
      dm.IqCont.Close;
