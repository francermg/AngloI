object DM: TDM
  ...
  object DsIntinerarios: TDataSource
    DataSet = Intinerarios
    Left = 1008
    Top = 384
  end
  object Intinerarios: TIBDataSet
    Database = DB_ANGLO
    Transaction = IBTr_ANGLO
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from INTINERARIOS'
      'where'
      '  CODIGO = :OLD_CODIGO')
    InsertSQL.Strings = (
      'insert into INTINERARIOS'
      '  (CODIGO, NOME_INTINERARIO)'
      'values'
      '  (:CODIGO, :NOME_INTINERARIO)')
    RefreshSQL.Strings = (
      'Select '
    ...
    object IntinerariosCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = '"INTINERARIOS"."CODIGO"'
      Required = True
    end
    object IntinerariosNOME_INTINERARIO: TIBStringField
      FieldName = 'NOME_INTINERARIO'
      Origin = '"INTINERARIOS"."NOME_INTINERARIO"'
      Size = 30
    end
  end
  object Formacao: TIBDataSet
    ...
    object FormacaoCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = '"FORMACAO"."CODIGO"'
      Required = True
    end
    object FormacaoNOME: TIBStringField
      FieldName = 'NOME'
      Origin = '"FORMACAO"."NOME"'
      Size = 30
    end
  end
  object dsformacao: TDataSource
    DataSet = Formacao
    Left = 1000
    Top = 448
  end
  object DsFor_Int: TDataSource
    DataSet = For_Int
    Left = 1008
    Top = 512
  end
  object For_Int: TIBDataSet
    Database = DB_ANGLO
    Transaction = IBTr_ANGLO
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from FOR_INT'
      'where'
      '  FORMACAO_CODIGO = :OLD_FORMACAO_CODIGO and'
    ...
    InsertSQL.Strings = (
      'insert into FOR_INT'
        ...
        '  (FORMACAO_CODIGO, INTINERARIOS_CODIGO, ARE_CONHECIMENTO_ID_ARE' +
        'A, COD_DICIPLINA)'
      'values'
      
        '  (:FORMACAO_CODIGO, :INTINERARIOS_CODIGO, :ARE_CONHECIMENTO_ID_' +
        'AREA, :COD_DICIPLINA)')
    RefreshSQL.Strings = (
      'Select '
      '  FORMACAO_CODIGO,'
      '  INTINERARIOS_CODIGO,'
      '  ARE_CONHECIMENTO_ID_AREA,'
      '  COD_DICIPLINA'
      'from FOR_INT '
      'where'
      '  FORMACAO_CODIGO = :FORMACAO_CODIGO and'
      '  INTINERARIOS_CODIGO = :INTINERARIOS_CODIGO and'
      '  ARE_CONHECIMENTO_ID_AREA = :ARE_CONHECIMENTO_ID_AREA and'
      '  COD_DICIPLINA = :COD_DICIPLINA')
    SelectSQL.Strings = (
      'select * from FOR_INT')
    ModifySQL.Strings = (
      'update FOR_INT'
      'set'
      '  FORMACAO_CODIGO = :FORMACAO_CODIGO,'
      '  INTINERARIOS_CODIGO = :INTINERARIOS_CODIGO,'
      '  ARE_CONHECIMENTO_ID_AREA = :ARE_CONHECIMENTO_ID_AREA,'
      '  COD_DICIPLINA = :COD_DICIPLINA'
      'where'
      '  FORMACAO_CODIGO = :OLD_FORMACAO_CODIGO and'
      '  INTINERARIOS_CODIGO = :OLD_INTINERARIOS_CODIGO and'
    ...
    object For_IntFORMACAO_CODIGO: TIntegerField
      FieldName = 'FORMACAO_CODIGO'
      Origin = '"FOR_INT"."FORMACAO_CODIGO"'
      Required = True
    end
    object For_IntINTINERARIOS_CODIGO: TIntegerField
      FieldName = 'INTINERARIOS_CODIGO'
      Origin = '"FOR_INT"."INTINERARIOS_CODIGO"'
      Required = True
    end
    object For_IntARE_CONHECIMENTO_ID_AREA: TIntegerField
      FieldName = 'ARE_CONHECIMENTO_ID_AREA'
      Origin = '"FOR_INT"."ARE_CONHECIMENTO_ID_AREA"'
      Required = True
    end
    object For_IntCOD_DICIPLINA: TIntegerField
      FieldName = 'COD_DICIPLINA'
      Origin = '"FOR_INT"."COD_DICIPLINA"'
      Required = True
    end
  end
  object DsConsultaConfHistorico: TDataSource
    DataSet = QConsultaConfHistorico
    Left = 1008
    Top = 568
  end
  object QConsultaConfHistorico: TIBQuery
    Database = DB_ANGLO
    Transaction = IBTr_ANGLO
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select distinct fo.nome as formacao, fo.codigo as cod_formacao,'
      
        'i.nome_intinerario as intinerario, i.codigo as cod_intinerario, ' +
        'a.nome_area as area,'
      
        'a.id_area as cod_area, d.nome as disciplina, d.codigo as cod_dis' +
        'ciplina'
      
        'from for_int f join formacao fo on (f.formacao_codigo=fo.codigo)' +
        ' join'
      
        'intinerarios i on (f.intinerarios_codigo = i.codigo) join are_co' +
        'nhecimento a on'
      
        'f.are_conhecimento_id_area=a.id_area join disciplinas d on (f.co' +
        'd_diciplina=d.codigo)')
    Left = 936
    Top = 568
    object QConsultaConfHistoricoFORMACAO: TIBStringField
      FieldName = 'FORMACAO'
      Origin = '"FORMACAO"."NOME"'
      Size = 30
    end
    object QConsultaConfHistoricoINTINERARIO: TIBStringField
      FieldName = 'INTINERARIO'
      Origin = '"INTINERARIOS"."NOME_INTINERARIO"'
      Size = 30
    end
    object QConsultaConfHistoricoAREA: TIBStringField
      FieldName = 'AREA'
      Origin = '"ARE_CONHECIMENTO"."NOME_AREA"'
      Size = 80
    end
    object QConsultaConfHistoricoDISCIPLINA: TIBStringField
      FieldName = 'DISCIPLINA'
      Origin = '"DISCIPLINAS"."NOME"'
      Size = 40
    end
    object QConsultaConfHistoricoCOD_FORMACAO: TIntegerField
      FieldName = 'COD_FORMACAO'
      Origin = '"FORMACAO"."CODIGO"'
      Required = True
    end
    object QConsultaConfHistoricoCOD_INTINERARIO: TIntegerField
      FieldName = 'COD_INTINERARIO'
      Origin = '"INTINERARIOS"."CODIGO"'
      Required = True
    end
    object QConsultaConfHistoricoCOD_AREA: TIntegerField
      FieldName = 'COD_AREA'
      Origin = '"ARE_CONHECIMENTO"."ID_AREA"'
      Required = True
    end
    object QConsultaConfHistoricoCOD_DISCIPLINA: TIntegerField
      FieldName = 'COD_DISCIPLINA'
      Origin = '"DISCIPLINAS"."CODIGO"'
      Required = True
    end
  end
  object DsapagaConf: TDataSource
    DataSet = Qapagaconfg
    Left = 1008
    Top = 256
  end
  object Qapagaconfg: TIBQuery
    Database = DB_ANGLO
    Transaction = IBTr_ANGLO
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      ...
      'from for_int'
        ...
        'where formacao_codigo = :bfor and INTINERARIOS_CODIGO = :binitne' +
        'rario and'
      
        'ARE_CONHECIMENTO_ID_AREA = :barea and COD_DICIPLINA = :bdiscipli' +
        'na')
    Left = 936
    Top = 256
    ParamData = <
    ...
    object QapagaconfgFORMACAO_CODIGO: TIntegerField
      FieldName = 'FORMACAO_CODIGO'
      Origin = '"FOR_INT"."FORMACAO_CODIGO"'
      Required = True
    end
    object QapagaconfgINTINERARIOS_CODIGO: TIntegerField
      FieldName = 'INTINERARIOS_CODIGO'
      Origin = '"FOR_INT"."INTINERARIOS_CODIGO"'
      Required = True
    end
    object QapagaconfgARE_CONHECIMENTO_ID_AREA: TIntegerField
      FieldName = 'ARE_CONHECIMENTO_ID_AREA'
      Origin = '"FOR_INT"."ARE_CONHECIMENTO_ID_AREA"'
      Required = True
    end
    object QapagaconfgCOD_DICIPLINA: TIntegerField
      FieldName = 'COD_DICIPLINA'
      Origin = '"FOR_INT"."COD_DICIPLINA"'
      Required = True
    end
