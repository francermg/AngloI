...
type
  TDoc_ContratoQR2 = class(TQuickRep)
    Rodape: TQRBand;
    QRShape1: TQRShape;
    QRShape2: TQRShape;
    QRLabel33: TQRLabel;
...
var
  Doc_ContratoQR2: TDoc_ContratoQR2;
...
procedure TDoc_ContratoQR2.RodapeBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
